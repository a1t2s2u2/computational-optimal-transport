% ============================================================
%  preamble.tex — Ambrosio ノート用 共通設定
%  記法は Ambrosio "Lecture Notes on Optimal Transport Problems" に準拠
% ============================================================
...
% --- Ambrosio 記法 ---
\newcommand{\Leb}{\mathcal{L}}              % ルベーグ測度 L^n
\newcommand{\Haus}{\mathcal{H}}             % ハウスドルフ測度 H^k
\newcommand{\Borel}{\mathcal{B}}            % ボレル σ-代数
\newcommand{\Meas}{\mathcal{M}}             % 符号付き Radon 測度
\newcommand{\Prob}{\mathcal{M}_1}           % 確率測度
\DeclareMathOperator{\Lip}{Lip}             % リプシッツ関数
\DeclareMathOperator{\spt}{spt}             % 台（support）
\newcommand{\Id}{\mathrm{Id}}               % 恒等写像
\newcommand{\pushforward}{_\#}              % 押し出し f_# μ
\newcommand{\Fcost}{\mathcal{F}}            % 最適輸送コスト
\newcommand{\Wass}{W}                       % Wasserstein 距離
