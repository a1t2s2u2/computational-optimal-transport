...
\begin{proof}
  ...
  $\Omega \in \mathcal{O}_d$ も任意の $r > 0$ で $B_r(x) \subset \Omega$ が
  成り立つことから従う．
...
\begin{definition}{完備性}{sem-complete-metric}
  ...
  $\Omega$ における任意の Cauchy 列 $(x_n)_{n \geq 1}$ に対し，
  \[
    \exists\, x \in \Omega,\quad x_n \to x
    \quad (n \to \infty)
  \]
  が成り立つことをいう（収束は定義~\ref{def:sem-convergence}）．
\end{definition}
