...
\begin{proof}
  ...
  $\CouplingsD(\mathbf{a},\mathbf{b})$ は非空（主張~\ref{clm:sem-discrete-kantorovich-existence}）
  かつコンパクト（同主張）であるから，
...
\begin{proof}
  ...
  \cap \{\mathbf{P} \mid \inner{\mathbf{C}}{\mathbf{P}} = \MKD_{\mathbf{C}}(\mathbf{a}, \mathbf{b})\}$
