...
\begin{proof}
  ...
  内分点の定義から
  $x_1 - x^* = (1-\lambda)(x_1 - x_2)$ かつ
  $x_2 - x^* = \lambda(x_2 - x_1) = -\lambda(x_1 - x_2)$ なので，
  第 1 式を $\lambda$ 倍，第 2 式を $(1-\lambda)$ 倍して加えると
  \begin{align*}
  ...
  \[
    ...
    \qquad (\forall\, i, j)
  \]
  が成り立ち，$\mathbf{P} \neq \mathbf{Q}$ より $P_{i_0,j_0} \neq Q_{i_0,j_0}$ をみたす成分
  $(i_0, j_0)$ が存在して，そこでは (1) より上の不等号が狭義に成り立つ．
  これらを $(i,j)$ について加えると
  \[
