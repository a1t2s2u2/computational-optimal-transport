...
連続 Kantorovich 問題（定義~\ref{def:sem-kantorovich}）に
離散測度（定義~\ref{def:sem-discrete-measure}）を代入すると，次の命題が示すとおり行列最適化へ帰着する．
...
\begin{remark}{線形計画と一意性}{sem-lp-uniqueness}
  離散 Kantorovich 問題（定義~\ref{def:sem-kantorovich}）は線形計画であるため，
...
\begin{remark}{エントロピー正則化による一意性の回復}{sem-entropy-uniqueness-preview}
  離散 Kantorovich 問題（定義~\ref{def:sem-kantorovich}）の最適解は一般に一意でないが，
  \textbf{離散エントロピー}
  \[
