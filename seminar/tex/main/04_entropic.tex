...
\begin{proof}
  ...
  \]
  となる．ここで $\dfrac{\partial F}{\partial P_{i,j}} = C_{i,j} + \varepsilon\log P_{i,j}$（注意~\ref{rem:sem-entropy-convention}），$\dfrac{dP^t_{i,j}}{dt} = a_i b_j - (\mathbf{P}_\varepsilon)_{i,j}$ を用いた．
